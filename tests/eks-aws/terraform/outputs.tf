...
output "argocd_url" {
  value = format("https://argocd.apps.%s", local.base_domain)
}

output "grafana_url" {
  value = format("https://grafana.apps.%s", local.base_domain)
}

output "prometheus_url" {
  value = format("https://prometheus.apps.%s", local.base_domain)
}

output "alertmanager_url" {
  value = format("https://alertmanager.apps.%s", local.base_domain)
}
